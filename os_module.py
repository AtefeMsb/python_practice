...
os.mkdir('os_demo')  # Use for making one directory
# os.makedirs('os_demo') # Use if you want to create multiple directories at once


# Remove directories
os.rmdir('os_demo') # Recommended use case
# os.removedirs('os_demo')  # Removes intermediate directories if specified


# Rename a file or folder
# os.rename(current_file_name, new_file_name). # This renames text.txt to demo.txt
